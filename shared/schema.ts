...
export const userMenuPermissions = pgTable("user_menu_permissions", {
  ...
  ownFarmingDashboard: boolean("own_farming_dashboard").default(false),
  ownFarmingSettings: boolean("own_farming_settings").default(false),
  mailManagement: boolean("mail_management").default(false),
